...
temp_dir = "/tmp/code-review-assistant"
...
def app():
    ...
    menu_items={
        ...
        'About': "# Code Review Assistant by Narvik Aghamalian. @2023 "
    }
        )

        session_state = st.session_state

        st.title("Code Review :eyes: Assistant")

  

        default_repo_url = "https://github.com/ideavision/Django-NLP-NER"
